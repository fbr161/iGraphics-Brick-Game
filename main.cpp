...
void homepg()
{
	...
	if(istp==3){
		...
		iText(130+50,300+50,"Developer:",GLUT_BITMAP_TIMES_ROMAN_24);
		iText(130+50+150,300+50,"Md. Fuad Bin Rahman",GLUT_BITMAP_TIMES_ROMAN_24);


		iText(130+50,300-50,"APL Project",GLUT_BITMAP_TIMES_ROMAN_24);
		iText(130+50,300-50-30-15,"United International University (UIU)",GLUT_BITMAP_TIMES_ROMAN_24);
		iText(130+50,300-50-30-15-45,"161 Batch",GLUT_BITMAP_TIMES_ROMAN_24);
		...
		iText(208+820-600-70,50+352-100+50,"G A M E    O V E R",GLUT_BITMAP_TIMES_ROMAN_24);
		iText(208+820-600-70+2,50+352-100+50,"G A M E    O V E R",GLUT_BITMAP_TIMES_ROMAN_24);
		iText(208+820-600-70+1,50+352-100+50,"G A M E    O V E R",GLUT_BITMAP_TIMES_ROMAN_24);

		iFilledRectangle(208+820-600-72,50+352-100+50-10,205,3);
	
		iText(208+820-600,50+352-100-30,"Score",GLUT_BITMAP_TIMES_ROMAN_24);
		iText(208+801-600,50+266-100-30,"High Score",GLUT_BITMAP_TIMES_ROMAN_24);

		iText(208+820-600,50+324-100-30,sc,GLUT_BITMAP_TIMES_ROMAN_24);
		iText(208+820-600,50+239-100-30,hsc,GLUT_BITMAP_TIMES_ROMAN_24);
